...
class VQABaseline(nn.Module):
    ...
    def __init__(self, vocab_size = 10000, word_embedding_size = 300, embedding_size = 1024, output_size = 1000,
                 ...
                 image_model_type = 'vgg16', dropout_prob = 0.5, train_cnn = False, use_dropout = False, attention_mechanism = 'element_wise_product', text_embedding = 'lstm'):
    ...
    def forward(self, images, questions):
        ...
        question_embeddings = self.question_encoder(questions) if self.text_embedding == 'lstm' else questions
