...
def main():
    ...
    parser.add_argument('--batch_size',           type=int,   help='batch size per CPU/GPU', default=512)
    ...
    optimizer    = Adadelta(model.parameters(), lr = args.learning_rate, betas = (args.beta1, args.beta2))
